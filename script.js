...
$("title").after(
  '<link rel="stylesheet" href="https://cdn.statically.io/gh/file-priv8/CDN/main/bootstrap-icons/1.10.5/icons.css">' +
  '<link rel="stylesheet" href="https://cdn.statically.io/gh/file-priv8/CDN/main/swiper/10/swiper-bundle.min.css">'
);
...
$(document).ready(function() {
  ...
  $(".top-poster img").each(function() {
    ...
    if (tp === "p1") {
      $(".swiper-slide #p1").attr({
        "src": $(p1).attr("src"),
        "location": $(p1).attr("location"),
        "title": $(p1).attr("title"),
        "desc": $(p1).attr("desc"),
        "year": $(p1).attr("year"),
        "rating": $(p1).attr("rating")
      });
    } else if (tp === "p2") {
      $(".swiper-slide #p2").attr({
        "src": $(p2).attr("src"),
        "location": $(p2).attr("location"),
        "title": $(p2).attr("title"),
        "desc": $(p2).attr("desc"),
        "year": $(p2).attr("year"),
        "rating": $(p2).attr("rating")
      });
    } else if (tp === "p3") {
      $(".swiper-slide #p3").attr({
        "src": $(p3).attr("src"),
        "location": $(p3).attr("location"),
        "title": $(p3).attr("title"),
        "desc": $(p3).attr("desc"),
        "year": $(p3).attr("year"),
        "rating": $(p3).attr("rating")
      });
    } else if (tp === "p4") {
      $(".swiper-slide #p4").attr({
        "src": $(p4).attr("src"),
        "location": $(p4).attr("location"),
        "title": $(p4).attr("title"),
        "desc": $(p4).attr("desc"),
        "year": $(p4).attr("year"),
        "rating": $(p4).attr("rating")
      });
    } else if (tp === "p5") {
      $(".swiper-slide #p5").attr({
        "src": $(p5).attr("src"),
        "location": $(p5).attr("location"),
        "title": $(p5).attr("title"),
        "desc": $(p5).attr("desc"),
        "year": $(p5).attr("year"),
        "rating": $(p5).attr("rating")
      });
    } else if (tp === "p6") {
      $(".swiper-slide #p6").attr({
        "src": $(p6).attr("src"),
        "location": $(p6).attr("location"),
        "title": $(p6).attr("title"),
        "desc": $(p6).attr("desc"),
        "year": $(p6).attr("year"),
        "rating": $(p6).attr("rating")
      });
    } else if (tp === "p7") {
      $(".swiper-slide #p7").attr({
        "src": $(p7).attr("src"),
        "location": $(p7).attr("location"),
        "title": $(p7).attr("title"),
        "desc": $(p7).attr("desc"),
        "year": $(p7).attr("year"),
        "rating": $(p7).attr("rating")
      });
    } else if (tp === "p8") {
      $(".swiper-slide #p8").attr({
        "src": $(p8).attr("src"),
        "location": $(p8).attr("location"),
        "title": $(p8).attr("title"),
        "desc": $(p8).attr("desc"),
        "year": $(p8).attr("year"),
        "rating": $(p8).attr("rating")
      });
    }
  });
